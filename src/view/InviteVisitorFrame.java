...
public class InviteVisitorFrame extends JFrame {
    ...
    private ResidentDashboard dashboard;
    ...
    public InviteVisitorFrame(int residentId, ResidentDashboard dashboard) {
        ...
        startSpinner.setEditor(new JSpinner.DateEditor(startSpinner, "hh:mm a"));
        ...
        endSpinner.setEditor(new JSpinner.DateEditor(endSpinner, "hh:mm a"));
    ...
    private void saveVisitor() {
        ...
        // Generate 8-character pass code and hash it
        ...
        try (Connection con = DBConnection.getConnection()) {
            ...
            String sql = "INSERT INTO visitors(resident_id, visitor_name, phone, has_vehicle, vehicle_no, access_hash, valid_from, valid_until) VALUES(?,?,?,?,?,?,?,?)";
            try (PreparedStatement ps = con.prepareStatement(sql)) {
                ...
                ps.setTimestamp(7, new java.sql.Timestamp(startCal.getTimeInMillis()));
                ps.setTimestamp(8, new java.sql.Timestamp(endCal.getTimeInMillis()));

                ps.executeUpdate();
            }

            // Refresh resident dashboard table dynamically
            if (dashboard != null) {
            ...
            JOptionPane.showMessageDialog(this,
                    "ACCESS PASS GENERATED\n\n" +
                            ...
                            "Code: " + code + "\n" +
                            "Valid: " +
                            new SimpleDateFormat("dd MMM hh:mm a").format(startCal.getTime()) +
                            " - " +
                            new SimpleDateFormat("hh:mm a").format(endCal.getTime()));
